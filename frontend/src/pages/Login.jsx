  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      if(state === 'Sign Up'){
        ...
        const {data} = await axios.post('https://serenocare-backend.onrender.com/api/user/register', {name, email, password})
        ...
        const {data} = await axios.post('https://serenocare-backend.onrender.com/api/user/login', {email, password})
