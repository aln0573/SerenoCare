...
const MyAppointment = () => {
  ...
  const getUsersAppointments = async () => {
    try {
      const { data } = await axios.get('https://serenocare-backend.onrender.com/api/user/appointments',{headers: {token}});
  ...
  const cancelAppointments = async (appointmentId) => {
    try {
      const { data } = await axios.post('https://serenocare-backend.onrender.com/api/user/cancel-appointment',{appointmentId},{headers: {token}});
      if (data.success) {
    ...
    const options = {
      ...
      handler: async (response) => {
        ...
        try {
          ...
          const {data} = await axios.post('https://serenocare-backend.onrender.com/api/user/verifyRazorpay', response , {headers: {token}})
  ...
  const appointmentRazorpay = async (appointmentId) => {
    try {
      ...
      const {data} = await axios.post('https://serenocare-backend.onrender.com/api/user/payment-razorpay', {appointmentId}, {headers: {token}})
